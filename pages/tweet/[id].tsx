...
export default function Post() {
  ...
  const fakeData = { id: 1, name: "holim", text: "hello", date: "22.11.25. 오후 4:31" };
  return (
              ...
              <div className="flex">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-sm">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maiores voluptatibus mollitia, quo odit
                    praesentium aspernatur quam veritatis. Perspiciatis, quos explicabo distinctio, totam iusto autem
                    tenetur veritatis dolore, unde laudantium nesciunt.
                  </span>
                </div>
              </div>
            </div>
